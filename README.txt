This test includes RestAssured, Selenium Webdriver, testNG and extentReports.
...
3. All test are gruped in two groups, run by testNG and also all asertions are made with testNG.

4. Extent report can be made using ExtentReport, creating html report files.
