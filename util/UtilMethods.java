...
public class UtilMethods {
	...
	public static List<String> getDataAsList(Response resp, String json) {

		JsonPath jsonPath = new JsonPath(resp.body().asString());
		List<String> data = jsonPath.getList(json);
		return data;
	}

	public static String createRandomMsg() {

		List<String> countries = Arrays.asList("Afghanistan", "Åland Islands", "Albania", "Algeria", "American Samoa",
				...
				"Virgin Islands (U.S.)", "Brunei Darussalam", "Bulgaria", "Burkina Faso", "Burundi", "Cambodia",
				"Cameroon", "Canada", "Cabo Verde", "Cayman Islands", "Central African Republic", "Chad", "Chile",
				"China", "Christmas Island", "Cocos (Keeling) Islands", "Colombia", "Comoros", "Congo",
				"Congo (Democratic Republic of the)", "Cook Islands", "Costa Rica", "Croatia", "Cuba", "Curaçao",
				...
				"Guyana", "Haiti", "Heard Island and McDonald Islands", "Holy See", "Honduras", "Hong Kong", "Hungary",
				"Iceland", "India", "Indonesia", "Côte d'Ivoire", "Iran (Islamic Republic of)", "Iraq", "Ireland",
				...
				"Korea (Democratic People's Republic of)", "Northern Mariana Islands", "Norway", "Oman", "Pakistan",
				...
				"South Georgia and the South Sandwich Islands", "Korea (Republic of)", "South Sudan", "Spain",
				...
				"Western Sahara", "Yugoslavia", "Yemen", "Zambia", "Zimbabwe");

		String msg = "I would like to wisit " + countries.get(random.nextInt(countries.size())) + " some day";
		return msg;
	}
